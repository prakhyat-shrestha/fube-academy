...
const HomeWorkEvaluationReportLayout = () => {
  return (
    <>
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Homework Evaluation Report</Link>
          </Typography>
        </nav>
      </div>
      <div className='homeWorkEvaluationReport mt-4' style={{ flex: 1 }}>
...
export default HomeWorkEvaluationReportLayout
