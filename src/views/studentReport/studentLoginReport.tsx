...
const StudentLoginReportLayout = () => {
  return (
    <>
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Student Login Info</Link>
          </Typography>
        </nav>
      </div>
      <div className='studentLogin mt-4' style={{ flex: 1 }}>
            ...
            <div className='container' style={{ display: 'flex' }}>
              ...
              >
                ...
                <MenuItem value='section'>
                  <span style={{ fontStyle: 'normal' }}>Select Current Section </span>
                </MenuItem>
              </CustomTextField>
            </div>
            <div
...
export default StudentLoginReportLayout
