      ...
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Previous Record</Link>
          </Typography>
        </nav>
      </div>
      <div className='previousRecord mt-4' style={{ flex: 1 }}>
          ...
          <CardContent>
            ...
            <div className='container' style={{ display: 'flex' }}>
              ...
              >
                ...
                <MenuItem value='year'>
                  <span style={{ fontStyle: 'normal' }}>Select Academic Year *</span>
                </MenuItem>
...
export default PreviousRecordLayout
