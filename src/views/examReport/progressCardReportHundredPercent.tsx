...
const ProgressCardReportHundredPercentLayout = () => {
  return (
    <>
      <div className='flex'>
        <Typography variant='h6' component='h3'>
          Progress Card Report 100 Percent
        </Typography>
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Progress Card Report 100 Percent</Link>
          </Typography>
        </nav>
      </div>
      <div className='progressCardReportHundredPercent mt-4' style={{ flex: 1 }}>
...
export default ProgressCardReportHundredPercentLayout
