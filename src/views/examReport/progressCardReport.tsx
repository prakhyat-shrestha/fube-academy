...
const ProgressCardReportLayout = () => {
  return (
    <>
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Progress Card Report</Link>
          </Typography>
        </nav>
      </div>
      <div className='progressCardReport mt-4' style={{ flex: 1 }}>
...
export default ProgressCardReportLayout
