      ...
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto' }}>
          <Typography variant='h6' component='h4' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Postal Dispatch</Link>
          </Typography>
        </nav>
      </div>
        ...
        <div className='postalDispatch mt-4'>
          <Card sx={{ width: 350, height: 'auto' }}>
            <CardContent>
              ...
              <CustomTextField label='FROM TITLE' required fullWidth sx={{ marginTop: '20px' }} />
            ...
            <CardContent>
              ...
              <TableContainer className='mt-4' component={Paper}>
                <Table sx={{ minWidth: 650 }} stickyHeader aria-label='sticky table'>
                  <TableHead>
                    <TableRow>
                      {['To Title', 'Reference No', 'Address', 'From Title', 'Note', 'Date', 'Action'].map(header => (
...
export default PostalDispatchLayout
