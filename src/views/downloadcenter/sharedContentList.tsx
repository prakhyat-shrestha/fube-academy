          ...
          <CardContent>
            ...
            <TableContainer className='mt-4' component={Paper}>
              <Table sx={{ minWidth: 650 }} stickyHeader aria-label='sticky table'>
                <TableHead>
                  <TableRow>
                    {['SL', 'Title', 'Send To', 'Share Date', 'Valid Upto', 'Shared By', 'Description', 'Action'].map(
                      header => (
...
export default SharedContentListLayout
