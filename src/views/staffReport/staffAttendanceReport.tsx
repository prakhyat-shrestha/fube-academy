...
const StaffAttendanceReportLayout = () => {
  return (
    <>
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Staff Attendance Report</Link>
          </Typography>
        </nav>
      </div>
      <div className='staffAttendanceReport mt-4' style={{ flex: 1 }}>
...
export default StaffAttendanceReportLayout
