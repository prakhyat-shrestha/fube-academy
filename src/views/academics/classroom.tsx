          ...
          <Card sx={{ width: 280, height: 275 }}>
            <CardContent>
              ...
              <Typography variant='body2' component='div'>
                <CustomTextField required label='ROOM NO ' style={{ marginTop: 20 }} />
              </Typography>
              <Typography variant='body2' component='div'>
                <CustomTextField required label='CAPACITY ' style={{ marginTop: 20 }} />
              </Typography>
            </CardContent>
                ...
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  ...
                  <tbody>
                    <tr style={{ borderBottom: '1px solid #ddd' }}>
                      <td style={{ paddingLeft: '4%' }}>012</td>
                      <td style={{ paddingLeft: '4%' }}>35</td>
