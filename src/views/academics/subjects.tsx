...
const records = Array.from({ length: 5 }, (_, index) => ({
  SL: index + 1,
  Name: ['	Creative And Arts', '	Science', 'Mathematics', 'Nepali', 'English'][index],
  SubjectType: 'Theory',
  SubCode: ['CD-CA', 'CD-SC', 'CD-MTH', 'CD-NP', 'CD-EN'][index],
  CreditHour: '2.00',
  TPP: [][index],
    ...
    <>
      ...
      <div className='flex' style={{ display: 'flex' }}>
        ...
        <div className='subject mt-4'>
          <Card sx={{ width: 350, height: 490 }}>
            <CardContent>
              <Typography variant='h6' component='h3'>
                Add Subject
              </Typography>
              <Typography variant='body2' component='div'>
                <CustomTextField required label=' SUBJECT NAME' style={{ marginTop: 20 }} />
              </Typography>
              <div style={{ marginTop: '20px' }}>
                <RadioGroup row aria-label='sizes' name='sizes' defaultValue='theory'>
                  <FormControlLabel value='theory' control={<Radio />} label='Theory' />
                  <FormControlLabel value='practical' control={<Radio />} label='Practical' />
                </RadioGroup>
              </div>
              <Typography variant='body2' component='div'>
                <CustomTextField required label='SUBJECT CODE' style={{ marginTop: 20 }} />
              </Typography>
              <Typography variant='body2' component='div'>
                <CustomTextField required label='CREDIT HOUR' style={{ marginTop: 20 }} />
              </Typography>
              <div style={{ marginTop: '20px' }}>
                <span>DOES THIS SUBJECT HAS THEME?</span>
            ...
            <CardContent>
              ...
              <TableContainer className='mt-4' component={Paper}>
                <Table sx={{ minWidth: 650 }} stickyHeader aria-label='sticky table'>
                  <TableHead>
                    <TableRow>
                      {['SL', 'Subject', 'Subject Type', 'Subject Code', 'Credit Hour', 'TTP', 'Action'].map(header => (
                  ...
                  <TableBody>
                    {records.slice((page - 1) * rowsPerPage, page * rowsPerPage).map(record => (
                      <TableRow key={record.SL}>
                        ...
                        <TableCell>{record.SubjectType}</TableCell>
                        <TableCell>{record.SubCode}</TableCell>
                        <TableCell>{record.CreditHour}</TableCell>
                        <TableCell>{record.TPP}</TableCell>
