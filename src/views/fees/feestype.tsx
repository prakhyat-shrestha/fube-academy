            ...
            <CardContent>
              ...
              <Typography variant='body2' component='div'>
                <CustomTextField
                  ...
                  style={{ marginTop: 20 }}
                >
                  <CustomTextField placeholder='Search...' style={{ padding: '0 0 8px 6px' }} />
            ...
            <CardContent>
              ...
              <TableContainer className='mt-4' component={Paper}>
                <Table sx={{ minWidth: 650 }} stickyHeader aria-label='sticky table'>
                  <TableHead>
                    <TableRow>
                      {['Name', 'Fees Group', 'Description', 'Action'].map(header => (
                  ...
                  <TableBody>
                    {records.slice((page - 1) * rowsPerPage, page * rowsPerPage).map(record => (
                      <TableRow key={record.SL}>
                        ...
                        <TableCell>{record.FeesGroup}</TableCell>
