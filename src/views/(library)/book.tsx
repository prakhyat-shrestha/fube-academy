...
const rows = [
  ...
  createData('Test','Theory of Relativity', 72842,'Science','German Publication','Albert Einstein',7,350,'nothing'),
  createData('Test','Rise Against Feminism', 11111,'Facts','Brian Publication','Brian Kaduwal',5000,10,'nothing'),
