  ...
  return (
    <>
      ...
      <div className='flex' style={{ display: 'flex' }}>
        ...
        <div className='bookSubject mt-4'>
          <Card sx={{ width: 350, height: 370 }}>
            <CardContent>
              <Typography variant='h6' component='h3'>
                Add Subject
              </Typography>
        ...
        {/* Subject list 2nd card */}
        <div className='subjectList mt-4 mx-6' style={{ flex: 1 }}>
            ...
            <CardContent>
              ...
              <TableContainer className='mt-4' component={Paper}>
                <Table sx={{ minWidth: 650 }} stickyHeader aria-label='sticky table'>
                  <TableHead>
                    <TableRow>
                      {['SL', 'Subject', 'Category Name', 'Subject Code', 'Action'].map(header => (
