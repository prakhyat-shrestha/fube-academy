  ...
  return (
    <>
      ...
      <div className='flex' style={{ display: 'flex' }}>
        {/* Add book category first card */}
        <div className='bookCategory mt-4'>
          <Card sx={{ width: 280, height: 210 }}>
            <CardContent>
              ...
              <Typography variant='body2' component='div'>
                <CustomTextField required label='CATEGORY NAME' style={{ marginTop: 20, width: '100%' }} />
              </Typography>
            </CardContent>
        ...
        {/* Book Category list 2nd card */}
        <div className='bookCategoryList mt-4 mx-6' style={{ flex: 1 }}>
...
export default BookCategoryLayout
