      ...
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Item Store List </Link>
          </Typography>
        </nav>
      </div>

      <div className='flex' style={{ display: 'flex' }}>
        {/* Add itemStore first card */}
        <div className='itemStore mt-4'>
          <Card sx={{ width: 350, height: 'auto' }}>
            <CardContent>
              <Typography variant='h6' component='h4'>
                Add Item Store
              </Typography>
              <CustomTextField label='STORE NAME' required style={{ width: '100%', marginTop: '20px' }} />
              <CustomTextField label='NUMBER' required style={{ width: '100%', marginTop: '20px' }} />
            ...
            <CardContent>
              ...
              <TableContainer className='mt-4' component={Paper}>
                <Table sx={{ minWidth: 650 }} stickyHeader aria-label='sticky table'>
                  <TableHead>
                    <TableRow>
                      {['Store Name', 'No', 'Description', 'Action'].map(header => (
...
export default ItemStoreLayout
