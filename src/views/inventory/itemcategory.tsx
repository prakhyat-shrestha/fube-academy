      ...
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Item Category List </Link>
          </Typography>
        </nav>
      </div>
        ...
        <div className='itemCategory mt-4'>
          <Card sx={{ width: 350, height: 'auto' }}>
            <CardContent>
              ...
              <CustomTextField label='CATEGORY NAME' required style={{ width: '100%', marginTop: '20px' }} />
            </CardContent>
...
export default ItemCateoryLayout
