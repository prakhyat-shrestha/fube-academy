...
const ItemReceiveListLayout = () => {
  ...
  return (
    <>
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Item Receive List</Link>
          </Typography>
        </nav>
      </div>

      {/* ADD NEW ITEM BUTTON */}
      <div className='addNewItem' style={{ display: 'flex', justifyContent: 'flex-end', marginTop: '10px' }}>
      ...
      {/* ---- Table Section ----*/}
      <div className='itemReceiveList mt-4 ' style={{ flex: 1 }}>
...
export default ItemReceiveListLayout
