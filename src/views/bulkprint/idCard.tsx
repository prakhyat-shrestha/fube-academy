...
const IDCardPrintLayout = () => {
  return (
    <>
      ...
      <div className='idcardbulkprint mt-4' style={{ flex: 1 }}>
          ...
          <CardContent>
            ...
            <div className='container' style={{ display: 'flex', alignItems: 'center', gap: '30px' }}>
              <Typography variant='body2' component='div' style={{ width: '40%' }}>
                <CustomTextField label='SELECT ROLE' defaultValue='select' select required fullWidth>
              ...
              <Typography variant='body2' component='div' style={{ width: '40%' }}>
                <CustomTextField label='SELECT ID CARD' required defaultValue='select' fullWidth select>
                  <CustomTextField placeholder='Search' style={{ padding: '0 6px 8px 6px', width: '100%' }} />
                  <MenuItem value='select'>
...
export default IDCardPrintLayout
