...
const ClassSectionReportLayout = () => {
  ...
  return (
    <>
      {/* ClassWiseRankSectionReport List First Card*/}
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto', display: 'flex', alignItems: 'center' }}>
          <Typography variant='h6' component='h3' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Class Section Wise Rank Report </Link>
          </Typography>
        </nav>
      </div>
...
export default ClassSectionReportLayout
