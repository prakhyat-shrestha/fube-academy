...
const StaffRegistrationLayout = () => {
  ...
  return (
    <>
      <div className='flex'>
        ...
        <nav style={{ marginLeft: 'auto' }}>
          <Typography variant='h6' component='h4' style={{ display: 'flex', alignItems: 'center' }}>
            ...
            <Link href='#'>Staff Registration </Link>
          </Typography>
        </nav>
      </div>

      {/*  1st card */}
      <div className='staffRegistration mt-4  ' style={{ flex: 1 }}>
        <Card sx={{ width: '100%', height: 'auto' }}>
          <CardContent>
            ...
            <div className='flex' style={{ gap: 30 }}>
              <CustomTextField label='LABEL' required fullWidth style={{ marginTop: '20px', width: '30%' }} />
              <CustomTextField
                label='TYPE'
                defaultValue='type'
                required
              ...
              >
                ...
                <MenuItem value='one'>Text Input</MenuItem>
                <MenuItem value='two'>Numeric Input</MenuItem>
                <MenuItem value='three'>Multiline Input</MenuItem>2
              </CustomTextField>
      ...
      {/* ---- Table Section ----*/}
      <div className='staffRegistrationList mt-7 ' style={{ flex: 1 }}>
        <Card sx={{ width: '100%', height: 'auto' }}>
          <CardContent>
            ...
            <TableContainer className='mt-4' component={Paper}>
              <Table sx={{ minWidth: 650 }} stickyHeader aria-label='sticky table'>
                <TableHead>
                  <TableRow>
                    {['SL', 'Label', 'Type', 'Width', 'Required', 'Value', 'Actions'].map(header => (
...
export default StaffRegistrationLayout
