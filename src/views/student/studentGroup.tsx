  ...
  return (
    <>
      ...
      <div className='flex' style={{ display: 'flex' }}>
          ...
          <Card sx={{ width: 280, height: 200 }}>
            <CardContent>
              ...
              <Typography variant='body2' component='div'>
                <CustomTextField required label='GROUP' style={{ marginTop: 20, width: '100%' }} />
              </Typography>
            </CardContent>
        ...
        {/* Student Group list 2nd card */}
        <div className='studentGroupList mt-4 mx-6' style={{ flex: 1 }}>
              ...
              <div style={{ marginTop: '20px' }}>
                <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                  ...
                  <tbody>
                    ...
                    <tr style={{ borderBottom: '1px solid #ddd' }}>
                      <td style={{ padding: '8px' }}>Janajati</td>
                      <td style={{ padding: '8px' }}>0</td>
                      <td style={{ padding: '8px' }}>
                        <Button variant='outlined' size='small' style={{ borderRadius: '20px' }}>
                          SELECT <ArrowDownwardIcon />
