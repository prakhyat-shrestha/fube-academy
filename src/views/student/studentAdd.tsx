  ...
  return (
    <Card>
      <div style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Button variant='contained' style={{ marginTop: '20px', height: '35px', marginRight: '25px' }}>
          <AddSharpIcon />
          Import Student
        </Button>
      </div>
      <TabContext value={value}>
        <TabList variant='scrollable' onChange={handleTabChange} className='border-be' style={{ marginLeft: '20px' }}>
          <Tab label='PERSONAL INFO' value='personal_info' style={{ fontSize: '12px' }} />
          <Tab label='PARENTS & GUARDIAN INFO' value='parentsandguardian_info' style={{ fontSize: '12px' }} />
          <Tab label='DOCUMENT INFO' value='document_info' style={{ fontSize: '12px' }} />
          <Tab label='PREVIOUS SCHOOL INFORMATION' value='previousschool_information' style={{ fontSize: '12px' }} />
          <Tab label='OTHER INFO' value='other_info' style={{ fontSize: '12px' }} />
          <Tab label='CUSTOM FIELD' value='custom_field' style={{ fontSize: '12px' }} />
          <Button
            variant='contained'
            style={{ marginTop: '7px', height: '35px', marginLeft: '63px', marginBottom: '10px' }}
          >
            <CheckSharpIcon />
            Save Student
          </Button>
        ...
        <form onSubmit={e => e.preventDefault()}>
          <CardContent>
            ...
            {/* NEXT PANEL */}
            <TabPanel value='parentsandguardian_info'>
              <div className='container' style={{ display: 'flex', justifyContent: 'space-between' }}>
            ...
            <TabPanel value='previousschool_information'>
              <div className='container' style={{ display: 'flex', justifyContent: 'space-between' }}>
                <div className='academic mt-4 mx-4 mb-4 ' style={{ width: '100%' }}>
